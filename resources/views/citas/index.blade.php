...
@section('content')
    ...
    <div id="modalCita"
        ...
        <div
            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 30px; border-radius: 12px; width: 90%; max-width: 500px;">
            <h3 id="modalTitulo" style="margin-bottom: 20px;">Detalles de Cita</h3>
            <div id="modalContenido"></div>
            <div style="margin-top: 25px; text-align: right;">
                <button onclick="cerrarModal()"
                    style="background: #6c757d; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer;">Cerrar</button>
            </div>
        </div>
    </div>
@endsection
        ...
        function cargarCitasProximas() {
            ...
            fetch('/api/citas/proximas')
                ...
                .then(data => {
                    if (!data.length) {
                        container.innerHTML =
                            '<p style="text-align: center; color: #666; padding: 20px;">No hay citas próximas</p>';
                        return;
                    }
                ...
                .catch(error => {
                    ...
                    container.innerHTML =
                        '<p style="text-align: center; color: #dc3545; padding: 20px;">Error al cargar citas</p>';
                });
        }
